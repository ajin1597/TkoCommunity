...
const NoticePage = () => {
    ...
    const { page } = useParams(); // 현제 페이지 , 파라이터값으로 사용
                                            ...
                                            <ul>
                                                <li>
                                                    <Link to={`/SingleNoticPage/${notic.num}`} className="flex">
                                                        ...
                                                        <div id="제목글" className=" bg-red-100 w-[50%] flex justify-center">{notic.title}</div>
                                                        <div id="작성자" className=" bg-red-200 w-[15%] flex justify-center">{notic.writer}</div>
                                                        <div id="작성시간" className=" bg-red-300 w-[25%] flex justify-center">{notic.date}</div>
                                                    </Link>
                                                </li>
                                            </ul>
                                        </nav>
